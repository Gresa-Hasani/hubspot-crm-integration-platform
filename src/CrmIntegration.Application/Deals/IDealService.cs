...
public interface IDealService
{
    ...
    Task<DealResponse> CreateAsync(CreateDealRequest request, CancellationToken cancellationToken = default);
    Task<DealResponse> UpdateAsync(Guid id, UpdateDealRequest request, CancellationToken cancellationToken = default);
}
